...
const templatesContent = `"use client";
...
fs.writeFileSync('frontend/src/app/(dashboard)/settings/workspace/templates/page.tsx', templatesContent);
console.log('Templates Settings created!');