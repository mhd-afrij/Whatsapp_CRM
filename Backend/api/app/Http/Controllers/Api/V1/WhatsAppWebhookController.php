...
/**
 * Receives push events from the whatsapp-sync Node service (session state
 * changes and inbound WhatsApp messages) and persists them. There is
 * currently one WhatsApp connection per deployment, so events are attributed
 * to a configurable default workspace rather than a resolved tenant —
 * see services.whatsapp_sync.default_workspace_slug.
 */
