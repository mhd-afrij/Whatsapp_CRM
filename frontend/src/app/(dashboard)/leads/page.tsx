...
function LeadsView() {
  ...
  return <main className='space-y-7 p-6 md:p-8'>
    <header className='flex flex-col gap-5 xl:flex-row xl:items-end xl:justify-between'>
      ...
      <button type='button' onClick={() => setShowNewLead(true)} className='inline-flex items-center justify-center gap-2 rounded-xl bg-primary px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-primary-dark'><Plus className='h-4 w-4' />New lead</button>
    </header>
