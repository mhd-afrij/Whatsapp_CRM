  ...
  return (
    <header className="h-16 border-b border-border-muted bg-background flex items-center justify-between px-4 gap-4 sticky top-0 z-10">
      <div className="flex items-center gap-2 text-sm text-text-secondary min-w-0">
        ...
        <span className="text-text-primary font-medium truncate">Dashboard</span>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <button type="button" className="rounded-md p-2 text-text-secondary hover:bg-surface-hover hover:text-text-primary">
          <Plus size={18} />
        </button>
        <button type="button" className="rounded-md p-2 text-text-secondary hover:bg-surface-hover hover:text-text-primary">
          <Bell size={18} />
