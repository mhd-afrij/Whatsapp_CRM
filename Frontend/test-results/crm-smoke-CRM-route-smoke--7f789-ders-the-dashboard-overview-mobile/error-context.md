...
- Name: crm-smoke.spec.ts >> CRM route smoke checks >> authenticates and renders the dashboard overview
- Location: e2e\crm-smoke.spec.ts:15:7
...
Locator: getByRole('heading', { name: /here.s the pulse/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /here.s the pulse/i })
